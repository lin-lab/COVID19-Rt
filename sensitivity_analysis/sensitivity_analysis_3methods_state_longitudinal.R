...
for (stateName in unique(jhu_states_pre$stateName)){
  ...
  png(paste0("./COVID19-Rt/sensitivity_analysis/results_3methods_state_longitudinal/slope_heatmap_Apr24_3methods_",stateName,".png"), width = 8, height = 8, units = 'in', res = 300)
