...
for (stateName in unique(jhu_states_pre$stateName)){
  ...
  png(paste0("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/state_rt/estimate_R_",stateName,".png"), width=8, height=6, units = 'in', res = 300)
...
M1[which(M1 > 1)] <- 1
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/corr_heatmap_Apr1_3methods.png", width = 8, height = 8, units = 'in', res = 300)
corrplot(M1,
         method = "circle",
         tl.col = "black",
         type = "upper",
...
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/slope_heatmap_Apr1_3methods.png", width = 8, height = 8, units = 'in', res = 300)
...
M1[which(M1 > 1)] <- 1
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/corr_heatmap_Apr24_3methods.png", width = 8, height = 8, units = 'in', res = 300)
corrplot(M1,
         method = "circle",
         tl.col = "black",
         type = "upper",
...
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/slope_heatmap_Apr24_3methods.png", width = 8, height = 8, units = 'in', res = 300)
...
M1[which(M1 > 1)] <- 1
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/corr_heatmap_May3_3methods.png", width = 8, height = 8, units = 'in', res = 300)
corrplot(M1,
         method = "circle",
         tl.col = "black",
         type = "upper",
...
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/slope_heatmap_May3_3methods.png", width = 8, height = 8, units = 'in', res = 300)
...
M1[which(M1 > 1)] <- 1
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/corr_heatmap_stayathome_3methods.png", width = 8, height = 8, units = 'in', res = 300)
corrplot(M1,
         method = "circle",
         tl.col = "black",
         type = "upper",
...
png("./COVID19-Rt/sensitivity_analysis/results_3methods_moving_average_state/slope_heatmap_stayathome_3methods.png", width = 8, height = 8, units = 'in', res = 300)
