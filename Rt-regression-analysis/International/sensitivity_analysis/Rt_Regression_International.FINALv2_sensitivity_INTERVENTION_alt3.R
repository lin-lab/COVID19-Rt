...
OUT_TABLE_NAME = paste0("/n/holystore01/LABS/xlin/Lab/covid19/sensitivity/International/INTERVENTION_ADDITIONAL/International_Rt_Intervention_alt3_Output.csv")
...
INTERVENTION_PARAMS <- list(
  ...
  MOB_VAR = "workplace" # which mobility category to use: residential or workplace
)
