# R code for running the sensitivity analysis for SPLINE parameters
...
for (choice in 1:dim(SPLINE_PARAMS_choices)[1]){
  ...
  OUT_TABLE_NAME = paste0("/n/holystore01/LABS/xlin/Lab/covid19/sensitivity/US/SPLINE/US_Rt_Intervention_Output_","KNOTS_DATE=",SPLINE_PARAMS_choices[choice,"KNOTS_DATE"],".csv")
