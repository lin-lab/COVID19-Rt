# R code for running the sensitivity analysis for OUTBREAK parameters
...
for (choice in 1:dim(OUTBREAK_PARAMS_choices)[1]){
  ...
  OUT_TABLE_NAME = paste0("/n/holystore01/LABS/xlin/Lab/covid19/sensitivity/US/OUTBREAK/US_Rt_Intervention_Output_","MIN_CASES=",OUTBREAK_PARAMS_choices[choice,"MIN_CASES"],".csv")
