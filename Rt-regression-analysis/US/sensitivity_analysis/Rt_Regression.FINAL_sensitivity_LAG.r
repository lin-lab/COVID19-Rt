# R code for running the sensitivity analysis for LAG parameters
...
for (choice in 1:dim(LAG_PARAMS_choices)[1]){
  ...
  OUT_TABLE_NAME = paste0("/n/holystore01/LABS/xlin/Lab/covid19/sensitivity/US/LAG/US_Rt_Intervention_Output_","SHAPE=",LAG_PARAMS_choices[choice,"SHAPE"],"_RATE=",LAG_PARAMS_choices[choice,"RATE"],".csv")
  ...
  HERD_PARAMS <- list(
    DAYS_IMMUNE = 90, # ** How long does immunity last after infection?
    ASC_RATIO = 2, # ** Ascertainment ratio (total:confirmed)
