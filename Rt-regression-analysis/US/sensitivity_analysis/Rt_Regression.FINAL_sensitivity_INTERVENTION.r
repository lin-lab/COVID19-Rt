...
for (choice in 1:dim(INTERVENTION_PARAMS_choices)[1]){
  ...
  OUT_TABLE_NAME = paste0("/n/holystore01/LABS/xlin/Lab/covid19/sensitivity/US/INTERVENTION/US_Rt_Intervention_Output_","DAYS_LAG=",INTERVENTION_PARAMS_choices[choice,"DAYS_LAG"],".csv")
